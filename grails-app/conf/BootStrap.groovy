...
class BootStrap {
    ...
    def init = { servletContext ->
		if (Environment.current == Environment.DEVELOPMENT) {
			...
			def kevin = new Employee(login:'kb123', password:'123456', firstName: "Kevin", lastName:"Beatty", hireDate : today-395).save()
			def moe = new Employee(login:'mh123', password:'123456', firstName: "Moe", lastName:"Howard", hireDate : today-1500).save()
			def larry = new Employee(login:'lf123', password:'123456', firstName: "Larry", lastName:"Fine", hireDate : today-3).save()
			def curly = new Employee(login:'ch123', password:'123456', firstName: "Curly", lastName:"Howard", hireDate : today-3650).save()
